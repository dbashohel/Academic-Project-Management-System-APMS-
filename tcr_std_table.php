        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6  col-lg-4 col-xxl-3">
                    <div class="cus_box">
                        <a href="tcr_std_reg_pending.php?status=pending" class="d-flex flex-column text-center gap-2">
                ...
                <div class="col-sm-6  col-lg-4 col-xxl-3">
                    <div class="cus_box">
                        <a href="tcr_students_info.php?status=approved" class="d-flex flex-column text-center gap-2">
                            <div class="card_top d-flex justify-content-between gap-3 align-items-center">
                                <div class="text_area ">
                            ...
                            <h6 class="cus_title">Registered Student</h6>
                        </a>
                    </div>
                </div>
            </div>
